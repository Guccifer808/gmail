...
const Email = ({ sender, title, time }) => {
  return (
    <div className="flex items-center justify-between border-b py-1.5 px-6 bg-gray-100 hover:bg-gray-200/75">
      <div className="">
        <p className="w-[8rem] font-semibold cursor-pointer truncate">
          {sender}
        </p>
      </div>
      <div className="flex items-center w-[18rem] sm:w-[30rem] lg:w-[60rem] truncate gap-2">
